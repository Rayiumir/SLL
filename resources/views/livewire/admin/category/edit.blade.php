<div wire:ignore.self class="modal fade" id="ModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
{{--                            @endforeach--}}
                ...
                <button type="button" wire:click="updateCategories" class="btn btn-primary rounded-5 mt-4"><i class="fa-duotone fa-user-plus"></i> ثبت کاربر </button>
